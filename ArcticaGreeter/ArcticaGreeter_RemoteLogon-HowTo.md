...
![AG-RemoteLogon_fig-01](/ArcticaProject/ArcticaDocs/ArcticaGreeter/img/AG-RemoteLogon_fig-01.png)

Next step choose **"`Erase Disk`"** and press Install Now.
If it asks you **“`Write the changes to disk?`”**, ignore it and press continue.

![AG-RemoteLogon_fig-02](/ArcticaProject/ArcticaDocs/ArcticaGreeter/img/AG-RemoteLogon_fig-02.png)
...
![AG-RemoteLogon_fig-03](/ArcticaProject/ArcticaDocs/ArcticaGreeter/img/AG-RemoteLogon_fig-03.png)
...
![AG-RemoteLogon_fig-04](/ArcticaProject/ArcticaDocs/ArcticaGreeter/img/AG-RemoteLogon_fig-04.png)


When the **“`Terminal`”** appears you will see a window similar to the picture below.

![AG-RemoteLogon_fig-05](/ArcticaProject/ArcticaDocs/ArcticaGreeter/img/AG-RemoteLogon_fig-05.png)

Now that the **“Terminal”** is open, run the following commands:

- **`sudo -i`** 
(This will give you access as an Admin/Superuser/Root.)
	- **NOTE:** After the command **"`sudo -i`"** it will ask you for a password, the password is the same you are using for your login. Also **NOTE** that it will not show your password when typed, it will instead keep a blank field while typing, so type it carefully and press enter.
...
![AG-RemoteLogon_fig-06](/ArcticaProject/ArcticaDocs/ArcticaGreeter/img/AG-RemoteLogon_fig-06.png)
